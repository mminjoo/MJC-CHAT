            ...
            <div className={style.chat_container}>
                ...
                <div className={style.chat_screen}>
                    <div className={style.chatting}>
                        <Conversation userType='user' content='휴학 신청 하고 싶다고!!!'></Conversation>
                        <Conversation userType='ai' content='휴학 신청을 하시려 하시네요! 명지전문대학에서는 휴학을 신청하고자 하는 학생은 소속 학과장을 경유하여 보호자 연서로 교무처장에게 휴학원을 제출하여야 합니다. 휴학원 제출 시에는 다음과 같은 서류를 첨부하여야 합니다. (내규 제23조 ⑥)
                                1. 휴학원서 (학교소정양식)
                                ...
                                이 외에 휴학의 절차와 규정을 확인하시기 바랍니다.'></Conversation>
                        <Conversation userType='ai' content='휴학 신청을 하시려 하시네요! 명지전문대학에서는 휴학을 신청하고자 하는 학생은 소속 학과장을 경유하여 보호자 연서로 교무처장에게 휴학원을 제출하여야 합니다. 휴학원 제출 시에는 다음과 같은 서류를 첨부하여야 합니다. (내규 제23조 ⑥)
                                1. 휴학원서 (학교소정양식)
                                2. 일반휴학 (보호자 사유서, 질병인 경우 의료법에서 정한 진료기관의 의사가 발행하는 진단서 )
                                3. 군입대휴학 (입영통지서 )
